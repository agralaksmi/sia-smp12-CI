...
--
-- Host: 127.0.0.1
-- Generation Time: 15 Mar 2018 pada 20.50
...
(21, 18, 30, 25, 56, 45, 45, 34, 56, 89, 63),
(22, 19, 30, 25, 78, 45, 34, 23, 45, 67, 52),
(23, 19, 31, 25, 67, 78, 90, 90, 66, 55, 67);
...
INSERT INTO `tb_wali_kelas` (`id_wali_kelas`, `id_guru`, `id_kelas`, `semester`, `id_tahun_ajaran`) VALUES
(1, 6, 14, 'Ganjil', 1);
...
--
ALTER TABLE `tb_detail_ketrampilan`
  MODIFY `id_detail_ketrampilan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `tb_detail_pengetahuan`
--
ALTER TABLE `tb_detail_pengetahuan`
  MODIFY `id_detail_pengetahuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `tb_guru_ampu`
  MODIFY `id_guru_ampu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `tb_nilai_ekskul`
  MODIFY `id_nilai_ekskul` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `tb_siswa_pertahun`
  MODIFY `id_siswa_pertahun` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
