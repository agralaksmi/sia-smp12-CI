...
<body class="hold-transition skin-black sidebar-mini">
  <div class="modal fade" id="modal_detailpengetahuan" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title" id="modal_detailpengetahuan">Tambah Nilai Pengetahuan</h4>
        </div>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="">UAS</label>
                  <input type="text" class="form-control" id="" placeholder="0" name="uas" required>
                  <p class="help-block"></p>
                </div>
              </div>
              <!-- AKHIR MEMBUAT FORM MENU -->
